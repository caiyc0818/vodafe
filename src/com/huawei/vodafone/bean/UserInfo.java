...
public class UserInfo {
	...
	public static ArrayList<PersonalInfo> orderByTime() {
		...
		for (int i = 0; i < UserInfo.getListsize(); i++) {
			...
			item.setHeadFaceImage(UserInfo.getHeadFaceImage(i));
	...
	public static String getHeadFaceImage(int position) {
		return getInfo(position, "HeadFaceImage");
	}

	public static String getHeadFaceImage() {
		return getInfo(getSelect(), "HeadFaceImage");
	}

	public static void setHeadFaceImage(String value) {
		setInfo(getSelect(), "HeadFaceImage", value);
	}
	...
	public static String getDddleftdata() {
		return getInfo(getSelect(), "Dddleftdata");
	}
	...
	public static void setAddleftData(String addleftdata) {
		setInfo(getSelect(), "Dddleftdata", addleftdata);
	}
