...
public class RequestJSon {
	...
	private static JsonObject getHeader() {
		...
		Header.addProperty("timestamp", DateUtil.ConverToString(new Date(), "yyyy-MM-dd HH:mm:ss"));
	 ...
	 * 5订阅订单
	 */
	public static JsonObject Optionaloffering(String dataId, String unitId, boolean isdiy) {
		JsonObject json = new JsonObject();
		json.addProperty("msisdn", UserInfo.getUserMobile());
		json.addProperty("salesChannelId", "1001");
		...
		ParameterItem2.setParameterCode("C_UNIT_LEVEL");
	 ...
	 * 6修改订单
	 */
	public static JsonObject modify(String dataId, String unitId, String OfferInstId, String OfferId) {
		JsonObject json = new JsonObject();
		json.addProperty("msisdn", UserInfo.getUserMobile());
		json.addProperty("salesChannelId", "1001");
	...
	public static String recharge(String mobile, int ammout) {
		...
		poststring.append("<cbs:MessageSeq>" + UUID.randomUUID() + "</cbs:MessageSeq>");
		...
		poststring.append("<cbs:Password>xyYSFeOUi5DagegPuCQmUQ==</cbs:Password>");
		...
		poststring.append("<arc:PrimaryIdentity>" + mobile + "</arc:PrimaryIdentity>");
