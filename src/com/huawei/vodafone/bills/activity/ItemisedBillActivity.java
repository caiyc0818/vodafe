...
public class ItemisedBillActivity extends FragmentActivity implements
	...
	private int[] imageIds = new int[] { Integer.valueOf(UserInfo
			.getHeadFaceImage()), Integer.valueOf(UserInfo
					.getHeadFaceImage())};
	...
	private void initView() {
		...
		ImageView imageView = new ImageView(this);
		imageView
				.setImageResource(Integer.valueOf(UserInfo.getHeadFaceImage()));
		images.add(imageView);
