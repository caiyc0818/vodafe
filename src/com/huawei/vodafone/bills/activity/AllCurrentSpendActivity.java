...
public class AllCurrentSpendActivity extends BaseActivity implements
	...
	private void initView() {
		...
		if (getIntent().getStringExtra("tag").equals("1")) {
			text_one.setText("Since 15th Sept 2016");
			text_two.setText("€22.98");
			text_three.setText("Last Updated 21st Sept 2016");
		...
		img_head.setImageResource(Integer.valueOf(UserInfo.getHeadFaceImage()));
