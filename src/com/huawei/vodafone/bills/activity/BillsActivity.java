...
public class BillsActivity extends FragmentActivity implements OnClickListener,
	...
	protected void onCreate(Bundle arg0) {
		...
		xValues1.add("April");
		xValues1.add("March");
		xValues1.add("February");
		xValues1.add("January");
		xValues1.add("December");
		xValues1.add("November");

		xValues2 = new ArrayList<String>();
		xValues2.add("8 Aug 2016");
		xValues2.add("7 Jul 2016");
		xValues2.add("6 Jun 2016");
		xValues2.add("5 May 2016");
		xValues2.add("4 Apr 2016");
		xValues2.add("3 Mar 2016");
		xValues2.add("2 Feb 2016");
