...
public class SettingsSimDetailsActivity extends BaseActivity implements
	...
	private void initView() {
		...
		text2.setText(mobile.substring(0, 4) + " "
				+ mobile.subSequence(4, mobile.length()));
		phone2.setText(mobile.substring(0, 4) + " "
				+ mobile.subSequence(4, mobile.length()));
		imageView.setImageResource(Integer.valueOf(UserInfo.getHeadFaceImage()));
	}
	...
	public void onClick(View v) {
		...
		case R.id.go_right:
			...
			if (num % 2 == 0) {
				...
				text2.setText("0778 5460399");
				phone2.setText("0778 5460399");
				...
				text2.setText("0778 3947975");
				phone2.setText("0778 3947975");
