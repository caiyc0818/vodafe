...
public class SettingsOffersAndExtrarsPlansDetailsActivity extends BaseActivity
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		plansDetail = (PlansItem) getIntent().getSerializableExtra(
				"plans_details");
		initView();
	}
	...
	private void initView() {
		...
		if (plansDetail.getLevelList() != null) {
			for (int i = 0; i < plansDetail.getLevelList().size(); i++) {
				if ("100000".equals(plansDetail.getLevelList().get(i)
						.getLevelId())) {
					text1.setText("300MB");
					tips_number.setText(" 300MB ");
				}
				if ("100001".equals(plansDetail.getLevelList().get(i)
						.getLevelId())) {
					text1.setText("500MB");
					tips_number.setText(" 500MB ");
				}
				if ("100002".equals(plansDetail.getLevelList().get(i)
						.getLevelId())) {
					text1.setText("800MB");
					tips_number.setText(" 800MB ");
				}

				if ("100006".equals(plansDetail.getLevelList().get(i)
						.getLevelId())) {
					text2.setText("100Min");
					text3.setText("unlimited");
				}
				if ("100007".equals(plansDetail.getLevelList().get(i)
						.getLevelId())) {
					text2.setText("300Min");
					text3.setText("unlimited");

				}
				if ("100008".equals(plansDetail.getLevelList().get(i)
						.getLevelId())) {
					text2.setText("500Min");
					text3.setText("unlimited");

				}
				double money = 0;
				int unit = Integer.valueOf(plansDetail.getFee()
						.getCurrencyUnit());
				money = money + plansDetail.getFee().getCurrencyValue()
						* Math.pow(10, -unit);
				text4.setText("€" + money + " "
						+ getResources().getString(R.string.settings_per_month));
			}
		}
		if (PreferenceUtils.getBoolean(
				SettingsOffersAndExtrarsPlansDetailsActivity.this, "haveDiy")) {
	...
	public void onClick(View v) {
		...
		case R.id.ll1:
			...
			if (tag % 2 == 0) {
				...
				android.view.ViewGroup.LayoutParams pp = rela1
						.getLayoutParams();
				...
				((ImageView) ll1.getChildAt(0))
						.setImageResource(R.drawable.settings_go_down);
			} else {
				...
				rela1.setLayoutParams(pp);
				((ImageView) ll1.getChildAt(0))
						.setImageResource(R.drawable.settings_go_up);
			}
			break;
		case R.id.ll2:
			tag1++;
			if (tag1 % 2 == 0) {
				...
				android.view.ViewGroup.LayoutParams pp = rela2
						.getLayoutParams();
		...
		case R.id.ll3:
			...
			if (tag3 % 2 == 0) {
				...
				LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
						...
						DensityUtil
								.dip2px(SettingsOffersAndExtrarsPlansDetailsActivity.this,
										85));
				params.setMargins(
						DensityUtil
								.dip2px(SettingsOffersAndExtrarsPlansDetailsActivity.this,
		...
		case 1001:
			if (resultCode == -1) {
				...
				PreferenceUtils.setBoolean(
						SettingsOffersAndExtrarsPlansDetailsActivity.this,
						"haveDiy", true);
